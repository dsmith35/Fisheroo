package com.dylan.fisheroo.armorequip;
...
import com.dylan.fisheroo.armorequip.ArmorEquipEvent.EquipMethod;
	...
	public void playerInteractEvent(PlayerInteractEvent e){
		...
		if(e.getAction() == Action.RIGHT_CLICK_AIR || e.getAction() == Action.RIGHT_CLICK_BLOCK){
			...
			if(newArmorType != null){
				...
				// Only proceed if the new armor is different from the old one
				if(isAirOrNull(oldArmor) || !oldArmor.isSimilar(e.getItem())) {
					ArmorEquipEvent armorEquipEvent = new ArmorEquipEvent(player, EquipMethod.HOTBAR, newArmorType, oldArmor, e.getItem());
					Bukkit.getServer().getPluginManager().callEvent(armorEquipEvent);
					if(armorEquipEvent.isCancelled()){
						e.setCancelled(true);
